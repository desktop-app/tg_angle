...
function(init_target target_name) # init_target(my_target folder_name)
    ...
    if (NOT TG_ANGLE_SPECIAL_TARGET STREQUAL "")
        set_target_properties(${target_name} PROPERTIES
    ...
    if (WIN32)
        ...
        PRIVATE
            ...
            NOMINMAX
            HAVE_SSE2
            DYNAMIC_ANNOTATIONS_ENABLED=$<IF:$<CONFIG:Debug>,1,0>
            $<$<CONFIG:Release>:NVALGRIND>
            _HAS_EXCEPTIONS=0
        )
        ...
        if (APPLE)
            ...
            if (NOT TG_ANGLE_SPECIAL_TARGET STREQUAL "" AND CMAKE_SIZEOF_VOID_P EQUAL 4)
                target_compile_options(${target_name}
                PRIVATE
                    -g0
                )
